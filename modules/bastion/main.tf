...
resource "aws_iam_role" "jykim_iam_role_ec2_instance_bastion" {
  name = "jykim-iam-role-ec2-instance-bastion"
...
resource "aws_iam_instance_profile" "jykim_ec2_instance_my_profile" {
  name = "jykim-ec2-instance-my-profile"
  role = aws_iam_role.jykim_iam_role_ec2_instance_bastion.name
}
